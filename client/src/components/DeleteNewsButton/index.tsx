...
export default function DeleteNewsButton({ newsId }: { newsId: string }) {
  ...
  return (
    <>
      <Modal isOpen={show} onClose={handleClose} containerStyles="min-w-[400px]">
        <div>
          <h3 className="font-semibold text-red-500 text-xl text-center">
            Are you sure want to delete?
          </h3>
          <div className="flex justify-center gap-4 mt-6">
            <button className="bg-gray-200 p-3 rounded-md" onClick={handleClose}>
              Cancel
            </button>
            <button
      ...
      <button onClick={handleOpen} className="p-2 rounded-full bg-red-200 text-red-600">
